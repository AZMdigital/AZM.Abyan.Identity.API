...
{
    //Task<OssFile?> GetByIdAsync(Guid id, CancellationToken cancellationToken = default);
    ...
    //Task UpdateAsync(OssFile file, CancellationToken cancellationToken = default);
